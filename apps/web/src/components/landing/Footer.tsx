      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-[var(--color-text-muted)] max-w-sm leading-relaxed">
              The AI-powered study mentor built for pharmacy students. Study
              smarter, stress less, ace your exams.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-[var(--color-border)]">
          <p className="text-sm text-[var(--color-text-muted)]">
            © 2026 AVANA. All rights reserved.
          </p>

          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <a
              href="#"
              className="p-2 rounded-lg hover:bg-[var(--color-border)] transition-colors text-[var(--color-text-muted)] hover:text-[var(--color-text)]"
            >
