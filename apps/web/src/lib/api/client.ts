...
/**
 * Generate a UUID v4 string safely across all environments:
 * - HTTPS secure contexts (crypto.randomUUID)
 * - HTTP insecure contexts (window.crypto.randomUUID is undefined on Safari / Chrome)
