  ...
  describe("Publish Eligibility Invariant (8 Conditions)", () => {
    ...
    it("1. Lesson accepted => has_publishable_content: true", async () => {
      generatedContentStore.insert({
        ...
        type: "lesson",
        status: "accepted",
        payload: { kind: "lesson", sessions: [{ title: "L1" }] } as unknown as GeneratedContentPayload,
        generationKey: null,
        promptVersion: null,
        model: "test-model",
        tokenUsage: null,
    ...
    it("4. Flashcard accepted => has_publishable_content: true", async () => {
      generatedContentStore.insert({
        ...
        type: "flashcard",
        status: "accepted",
        payload: { kind: "flashcard", cards: [{ question: "Q1", answer: "A1" }] } as unknown as GeneratedContentPayload,
        generationKey: null,
        promptVersion: null,
        model: "test-model",
        tokenUsage: null,
    ...
    it("5. Quiz accepted => has_publishable_content: true", async () => {
      generatedContentStore.insert({
        ...
        type: "quiz",
        status: "accepted",
        payload: { kind: "quiz", questions: [{ question: "Q1", options: ["A", "B"], correctIndex: 0 }] } as unknown as GeneratedContentPayload,
        generationKey: null,
        promptVersion: null,
        model: "test-model",
        tokenUsage: null,
    ...
    it("6. Review Summary accepted => has_publishable_content: true", async () => {
      generatedContentStore.insert({
        ...
        type: "review_summary",
        status: "accepted",
        payload: { kind: "review_summary", summary: "Test summary", keyTakeaways: [] } as unknown as GeneratedContentPayload,
        generationKey: null,
        promptVersion: null,
        model: "test-model",
        tokenUsage: null,
