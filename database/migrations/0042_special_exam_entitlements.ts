...
/**
 * Migration 0042: Special Exam Entitlements Support.
 *
 * Updates user_entitlements check constraint to support direct 'special_exam' entitlements
 * alongside 'course', 'content_pack', 'content', and 'subscription'.
 *
 * Invariant:
 * - resource_id MUST BE NULL for 'subscription'
 * - resource_id MUST BE NOT NULL for 'course', 'content_pack', 'content', and 'special_exam'
 *
